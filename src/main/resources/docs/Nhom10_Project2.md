...
[2.2. Phương pháp khảo sát [1](#phương-pháp-khảo-sát)](#phương-pháp-khảo-sát)

[2.3. Khảo sát hệ thống YODY (yody.vn) [1](#khảo-sát-hệ-thống-yody-yody.vn)](#khảo-sát-hệ-thống-yody-yody.vn)

[2.3.1. Trang chủ (Homepage) [2](#_Toc232496436)](#_Toc232496436)

[2.3.2. Trang danh mục sản phẩm [4](#_Toc232496437)](#_Toc232496437)

[2.3.3. Trang chi tiết sản phẩm [5](#_Toc232496438)](#_Toc232496438)

[2.3.4. Tính năng nổi bật [6](#_Toc232496439)](#_Toc232496439)

[2.3.5. Điểm hạn chế [6](#_Toc232496440)](#_Toc232496440)

[2.4. Khảo sát hệ thống COOLMATE (coolmate.me) [7](#khảo-sát-hệ-thống-coolmate-coolmate.me)](#khảo-sát-hệ-thống-coolmate-coolmate.me)

[2.4.1. Trang chủ (Homepage) [7](#_Toc232496442)](#_Toc232496442)

[2.4.2. Trang danh mục sản phẩm [9](#_Toc232496443)](#_Toc232496443)

[2.4.3. Trang chi tiết sản phẩm [10](#_Toc232496444)](#_Toc232496444)

[2.4.4. Tính năng nổi bật [12](#_Toc232496445)](#_Toc232496445)
...
[3.1.1. Yêu cầu chức năng nghiệp vụ [14](#_Toc232496449)](#_Toc232496449)

[3.1.2. Yêu cầu chức năng hệ thống [25](#_Toc232496450)](#_Toc232496450)
...
[3.4.1. Module Tài khoản & Xác thực [33](#_Toc232496454)](#_Toc232496454)

[3.4.2. Module Sản phẩm & Danh mục [43](#_Toc232496455)](#_Toc232496455)

[3.4.3. Module đơn hàng và giỏ hàng [55](#_Toc232496456)](#_Toc232496456)

[3.4.5. Module đánh giá, voucher, wishlist, thống kê và nội dung [66](#_Toc232496457)](#_Toc232496457)

[3.5. Lược đồ tuần tự của một số use case chính [79](#lược-đồ-tuần-tự-của-một-số-use-case-chính)](#lược-đồ-tuần-tự-của-một-số-use-case-chính)

[3.5.1. Use case 04 - Quên mật khẩu [79](#_Toc232496459)](#_Toc232496459)

[3.5.2. Use case 14 - Xem chi tiết sản phẩm [81](#_Toc232496460)](#_Toc232496460)

[3.5.3. Usecase 15 - Thêm sản phẩm mới [82](#_Toc232496461)](#_Toc232496461)

[3.5.4. Usecase 17 - Thêm sản phẩm vào giỏ hàng [83](#_Toc232496462)](#_Toc232496462)
...
Nhằm phục vụ cho việc phân tích và thiết kế hệ thống "Website bán quần áo", nhóm tiến hành khảo sát hiện trạng các hệ thống thương mại điện tử thời trang đang hoạt động trên thị trường Việt Nam. Mục tiêu của quá trình khảo sát bao gồm: tìm hiểu các tính năng phổ biến mà một website bán quần áo cần có; nhận diện các tính năng nổi bật, khác biệt của từng hệ thống; phát hiện các điểm hạn chế hoặc tính năng còn thiếu sót. Từ đó đề xuất danh sách yêu cầu cho phần mềm của nhóm, đảm bảo vừa đáp ứng các chức năng cơ bản, vừa có tính năng cải tiến và sáng tạo.

# 1.2. Phương pháp khảo sát {#phương-pháp-khảo-sát .P2}

Nhóm tiến hành khảo sát bằng phương pháp quan sát trực tiếp (direct observation) trên giao diện website của 2 hệ thống bán quần áo trực tuyến tiêu biểu tại Việt Nam:

| STT | Tên hệ thống | Địa chỉ website       | Đối tượng khách hàng chính  |
|-----|--------------|-----------------------|-----------------------------|
...
[]{#_Toc232496439 .anchor}1.3.4. Tính năng nổi bật
...
[]{#_Toc232496440 .anchor}1.3.5. Điểm hạn chế

| STT | Điểm hạn chế | Mô tả chi tiết |
|----|----|----|
| 1 | Không có hệ thống đánh giá sản phẩm | Trang chi tiết sản phẩm không hiển thị rating sao hay bình luận từ khách hàng |
| 2 | Không có Wishlist (Yêu thích) | Không có nút lưu sản phẩm yêu thích để xem lại sau |
| 3 | Không có sản phẩm gợi ý / liên quan | Trang chi tiết không hiển thị sản phẩm tương tự hay sản phẩm đề xuất |
...
[]{#_Toc232496445 .anchor}1.4.4. Tính năng nổi bật
...
[]{#_Toc232496446 .anchor}1.4.5. Hạn chế

| **STT** | **Điểm hạn chế** | **Mô tả chi tiết** |
|----|----|----|
| 1 | Không có Wishlist (Yêu thích) | Không có nút lưu sản phẩm yêu thích trên trang chi tiết hoặc danh mục |
...
Danh mục: Mã danh mục, tên danh mục, danh mục cha (Nam/Nữ/Trẻ em), mô tả, thứ tự hiển thị.

Khách hàng: Mã KH, họ tên, email, SĐT, mật khẩu (mã hóa), giới tính, ngày sinh, địa chỉ giao hàng (nhiều địa chỉ), hạng thành viên.

Đơn hàng: Mã ĐH, mã KH, ngày đặt, trạng thái (chờ xác nhận/đang giao/hoàn thành/đã hủy), tổng tiền, phí ship, mã giảm giá, phương thức thanh toán, địa chỉ giao.

Chi tiết đơn hàng: Mã ĐH, mã biến thể SP, số lượng, đơn giá, thành tiền.

Đánh giá sản phẩm: Mã đánh giá, mã KH, mã SP, số sao (1--5), nội dung, hình ảnh đính kèm, ngày đánh giá, trạng thái duyệt.

Voucher/Mã giảm giá: Mã voucher, loại (% hoặc số tiền), giá trị, điều kiện áp dụng, ngày bắt đầu, ngày kết thúc, số lượng, số lần đã dùng.

Bộ sưu tập: Mã BST, tên BST, mô tả, banner, danh sách SP, thời gian hiển thị.

**Tra cứu:**

Tìm kiếm sản phẩm: theo tên, từ khóa, danh mục, có gợi ý khi gõ (autocomplete).

Lọc sản phẩm: theo size, màu sắc, chất liệu, khoảng giá, dịp phù hợp.

Sắp xếp: theo giá tăng/giảm, mới nhất, bán chạy, đánh giá cao.

Tra cứu đơn hàng: theo mã ĐH, trạng thái, khoảng thời gian.

Tra cứu khách hàng: theo tên, email, SĐT, hạng thành viên.

Kiểm tra tồn kho: theo mã SP, biến thể (size + màu).

**Tính toán:**

Tính tổng tiền đơn hàng: Σ(đơn giá × số lượng) + phí ship -- giảm giá.

Tính phí vận chuyển: dựa trên khu vực giao hàng và trọng lượng.

Tính điểm tích lũy thành viên: 1 điểm = 1.000 VNĐ mua hàng.

Tính giá khuyến mãi: giá gốc × (1 -- % giảm).

Thống kê doanh thu: theo ngày/tuần/tháng/năm, theo danh mục, theo sản phẩm.

**Kết xuất:**

Báo cáo doanh thu theo khoảng thời gian (BM1).

Danh sách sản phẩm bán chạy (BM2).

Báo cáo tồn kho (BM3).

Danh sách đơn hàng theo trạng thái (BM4).

Báo cáo khách hàng thân thiết (BM5).
...
**BM1 - Báo cáo doanh thu:**

| Khoảng thời gian | Tổng đơn hàng | Đơn hoàn thành | Đơn hủy | Tổng doanh thu | Tổng giảm giá | Doanh thu thực |
|----|----|----|----|----|----|----|
| 01/2026 | 150 | 135 | 15 | 450.000.000 đ | 25.000.000 đ | 425.000.000 đ |

**BM2 - Sản phẩm bán chạy:**

| Hạng | Mã SP | Tên sản phẩm       | Danh mục       | Số lượng bán | Doanh thu   |
|------|-------|--------------------|----------------|--------------|-------------|
| 1    | SP001 | Áo Polo Nam Cotton | Nam \> Áo Polo | 320          | 159.680.000 |

**BM3 - Báo cáo tồn kho:**

| Mã SP | Tên sản phẩm       | Biến thể (Size/Màu) | Tồn kho | Trạng thái |
|-------|--------------------|---------------------|---------|------------|
| SP001 | Áo Polo Nam Cotton | L / Trắng           | 5       | Sắp hết    |
| SP001 | Áo Polo Nam Cotton | M / Đen             | 50      | Còn hàng   |

**BM4 - Danh sách đơn hàng:**

| Mã ĐH | Khách hàng   | Ngày đặt   | Tổng tiền | Phương thức TT | Trạng thái |
|-------|--------------|------------|-----------|----------------|------------|
| DH001 | Nguyễn Văn A | 15/01/2026 | 1.250.000 | VNPay          | Hoàn thành |
| DH002 | Trần Thị B   | 16/01/2026 | 890.000   | COD            | Đang giao  |

**BM5 - Báo cáo khách hàng thân thiết:**

| Mã KH | Họ tên       | Hạng | Điểm tích lũy | Tổng chi tiêu | Số đơn hàng |
|-------|--------------|------|---------------|---------------|-------------|
...
<tr>
<td>1</td>
<td>Chọn SP từ danh sách → nhấn<br />
“Sửa”</td>
<td>Hiển thị form cập nhật với dữ liệu hiện tại (mã SP readonly)</td>
</tr>
<tr>
<td>2</td>
<td>Chỉnh sửa thông tin: tên, mô tả, giá, hình ảnh, biến thể</td>
<td></td>
</tr>
<tr>
<td>3</td>
<td>Nhấn “Lưu thay đổi”</td>
<td>Validate dữ liệu, cập nhật CSDL. Giá mới chỉ áp dụng cho đơn hàng mới</td>
</tr>
<tr>
<td>4</td>
<td></td>
<td>Hiển thị “Cập nhật thành công”</td>
</tr>
</tbody>
</table>
...
  - Đóng gói thuật toán linh hoạt: Hệ thống yêu cầu nhiều phương pháp thanh toán với cơ chế gọi API và mã hóa checksum khác nhau hoàn toàn. Pattern này đóng gói từng thuật toán vào các class triển khai riêng biệt, giao quyền quyết định chiến lược cho "PaymentContex" tại thời điểm runtime (thực thi).
...
  - Định hình cấu trúc bất biến: Định nghĩa một "bộ khung" ("CsvReportExporterTemplate") chuẩn hóa thuật toán xuất CSV gồm 4 bước cố định: Ghi mã BOM (UTF-8) -\> Ghi tiêu đề Header -\> Duyệt ghi dữ liệu từng dòng (Row) -\> Flush bộ đệm.
...
  - Cung cấp một interface sử dụng cấp cao, đơn giản cho Controller (ví dụ như hàm "login()", "register()"). Đằng sau nó che giấu sự tương tác phức tạp của "UserRepository", "PasswordEncoder", "JwtTokenProvider", "RedisTemplate", và "EmailService".
